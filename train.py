...
tf.flags.DEFINE_string('X', 'data/tfrecords/metal.tfrecords',
                       'X tfrecords file for training, default: data/tfrecords/metal.tfrecords')
tf.flags.DEFINE_string('Y', 'data/tfrecords/stone.tfrecords',
                       'Y tfrecords file for training, default: data/tfrecords/stone.tfrecords')
