...
tf.flags.DEFINE_string('XtoY_model', 'metal2stone.pb', 'XtoY model name, default: metal2stone.pb')
tf.flags.DEFINE_string('YtoX_model', 'stone2metal.pb', 'YtoX model name, default: stone2metal.pb')
