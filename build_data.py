...
tf.flags.DEFINE_string('X_input_dir', 'data/metal2stone/trainA',
                       'X input directory, default: data/metal2stone/trainA')
tf.flags.DEFINE_string('Y_input_dir', 'data/metal2stone/trainB',
                       'Y input directory, default: data/metal2stone/trainB')
tf.flags.DEFINE_string('X_output_file', 'data/tfrecords/metal.tfrecords',
                       'X output tfrecords file, default: data/tfrecords/metal.tfrecords')
tf.flags.DEFINE_string('Y_output_file', 'data/tfrecords/stone.tfrecords',
                       'Y output tfrecords file, default: data/tfrecords/stone.tfrecords')
